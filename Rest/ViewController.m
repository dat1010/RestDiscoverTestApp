...
didReceiveAuthenticationChallenge:(NSURLAuthenticationChallenge *)challenge
{
         ...
         isEqualToString:NSURLAuthenticationMethodServerTrust])
    {
        ...
        if ([challenge.protectionSpace.host isEqualToString:@"https://discoverservice.bluesphereqa.com/"])
        {
...
- (IBAction)getContact;
{
    ...
    NSURL *url = [NSURL URLWithString:@"https://discoverservice.bluesphereqa.com/api/testcontact"];
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url];
    [request setValue:@"application/xml" forHTTPHeaderField:@"Content-Type"];
    [request setValue:@"application/xml" forHTTPHeaderField:@"Accept"];
    NSURLConnection *connect = [NSURLConnection connectionWithRequest:request delegate:self];
    
//    [self connection:connect canAuthenticateAgainstProtectionSpace:];
...
- (IBAction)updateContact;
{
    ...
    NSURL *url = [NSURL URLWithString:@"http://discoverservice.bluesphereqa.com/api/testcontact"];
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url];
...
- (IBAction)logIn;
{
    ...
    NSURL *url = [NSURL URLWithString:@"http://discoverservice.bluesphereqa.com/api/contact"];
    ...
    //NSString *post = [NSString stringWithFormat:@"url=%@,name=%@,password=%@",discoverurl,name,password];
    ...
    if (error){
        ...
        NSLog(@"There was an error. Please check your username and password");
    }
